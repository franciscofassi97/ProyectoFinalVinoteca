const TerminosYCondiciones = () => {
  return (
    <div>
      ...
      <br />
      <p>
        Todas los productos que son ofrecidos por nuestro sitio web pudieran ser
        creados, cobrados, enviados o presentados por una página web tercera y
      ...
      <br />
      <p>
        La Vinoteca de JOSE no asume la responsabilidad en caso de que entregue
        dicha clave a terceros. Todas las compras y transacciones que se lleven
        a cabo por medio de este sitio web, están sujetas a un proceso de
        confirmación y verificación, el cual podría incluir la verificación del
        stock y disponibilidad de producto, validación de la forma de pago,
        validación de la factura (en caso de existir) y el cumplimiento de las
      ...
      <br />
      <p>
        La Vinoteca de Jose a través de su sitio web concede una licencia para
      ...
      <br />
      <p>
        Este garantiza que la información personal que usted envía cuenta con la
        ...
        momento de crear su cuenta. La Vinoteca de Jose reserva los derechos de
